...
public class JwtProvider {
    ...
    public static String generateToken(Authentication auth) {
        ...
        System.out.println("generateToken roles: " + auth);
        System.out.println("generateToken authorities: " + authorities);
        System.out.println("generateToken username: " + auth.getName());
