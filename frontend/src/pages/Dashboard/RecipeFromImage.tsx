  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="text-center mb-8">
        <ChefHat className="mx-auto h-12 w-12 text-blue-600" />
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <ImageUpload
          onImageUpload={(base64) => setRequest({ ...request, image: base64 })}
        />
